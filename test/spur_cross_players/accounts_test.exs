defmodule SpurCrossPlayers.AccountsTest do
  use SpurCrossPlayers.DataCase

  alias SpurCrossPlayers.Accounts

  import SpurCrossPlayers.AccountsFixtures
  alias SpurCrossPlayers.Accounts.{Account, AccountToken}
  ...
  describe "get_account!/1" do
    test "raises if id is invalid" do
      assert_raise Ecto.NoResultsError, fn ->
        Accounts.get_account!("11111111-1111-1111-1111-111111111111")
      end
    end
