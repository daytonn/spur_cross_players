defmodule SpurCrossPlayersWeb.AccountAuthTest do
  use SpurCrossPlayersWeb.ConnCase, async: true

  alias SpurCrossPlayers.Accounts
  alias SpurCrossPlayersWeb.AccountAuth
  import SpurCrossPlayers.AccountsFixtures

  @remember_me_cookie "_spur_cross_players_web_account_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SpurCrossPlayersWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_account/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SpurCrossPlayersWeb.Endpoint.subscribe(live_socket_id)
