defmodule SpurCrossPlayers.Accounts.Account do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, SpurCrossPlayers.Repo)
  ...
  """
  def valid_password?(
        %SpurCrossPlayers.Accounts.Account{hashed_password: hashed_password},
        password
      )
